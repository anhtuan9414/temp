        ...
        while True:
            ...
            try:
                pretty_print(get_string("connection_search"),
                             "info", "net0")
                response = {"client":"96.41.45.123","ip":"162.212.157.226","name":"iowa-pool-1","port":1092,"region":"NA","server":"duino-svko-1","success":True}
...
def check_mining_key(user_settings):
    ...
    response = {"has_key": True, "success": True}
        ...
        if not Path(Settings.DATA_DIR + Settings.SETTINGS_FILE).is_file():
            ...
            while not correct_username:
                ...
                r = {
                    "result": {
                        "balance": {
                            "balance": 44.23732180153023,
                            "created": "before 23.08.2021",
                            "last_login": 1683358214,
                            "stake_amount": 0,
                            "stake_date": 0,
                            "trust_score": 5,
                            "username": "tuanna9414",
                            "verified": "no",
                            "verified_by": "Duino admin",
                            "verified_date": 0,
                            "warnings": 0
                            },
                        "miners": [],
